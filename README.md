...
El usuario introduce una combinación de 4 colores de entre 6 (amarillo, verde, azul, negro, marrón, morado) colores disponibles con posibilidad de repetir,
para que el algoritmo tenga un código válido que intentar adivinar.
...
En cada ronda, el algoritmo propone una combinación de 4 colores para el acierto del código secreto.
Cada nuevo intento debe tener en cuenta la información obtenida en los intentos anteriores e irse acercando más al código oculto.
